...
<h2>Tema Lambda - Tema responsive para Moodle Moodle 2.5/2.6/2.7/2.8</h2>
</div>
<h4>Caracter&iacute;sticas del tema</h4>
<div style="color: #888; text-transform: uppercase; margin-bottom:20px;">
<p>Compatibilidad: Moodle 2.5/2.6/2.7/2.8<br />Versi&oacute;n del tema: 1.4<br />Tema matriz: Bootstrapbase de Bas Brands<br />Basado en: Essential de Julian Ridden</p>
</div>
<hr />
